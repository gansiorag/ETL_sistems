...
def getAllUsersChanel(NameChanel:str, NameData:str):
    ...
    nameFileUser = f'{WorkDir[0]}/ETL_sistems/datasets_com/{NameData}/' + NameChanel.split('/')[-1] +'_' + dataText +'_User.txt'   
    while True:
...
def getInfoChanel(NameChanel:str, NameData:str):
    ...
    # limitUsers = 100
    # all_participants = []
    #nameFileUser = f'{WorkDir[0]}/ETL_sistems/datasets_com/{NameData}/' + NameChanel.split('/')[-1] + '_User.txt'
    nameFileMes = f'{WorkDir[0]}/ETL_sistems/datasets_com/{NameData}/' + NameChanel.split('/')[-1] + '_Mes.txt'
...
if __name__ == '__main__':
    listName = ['https://t.me/javascript_jobs_feed']
    for NameChanel in listName:
        #getAllUsersChanel(NameChanel, 'JobJavaScript')
        getInfoChanel(NameChanel, 'JobJavaScript')
